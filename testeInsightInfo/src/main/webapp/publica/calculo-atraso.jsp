...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6">
            <img class="ml-5 rounded-corners" alt="" src="${pageContext.request.contextPath}/resources/imagens/atrasos.png" style="width: 89%;height: auto;border-radius: 130px;">
    ...
    <!-- Restante dos elementos HTML e scripts -->
</body>
</html>
